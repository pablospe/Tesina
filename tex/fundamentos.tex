...
\end{align*}
dando lugar a los polinomios de Legendre-Sobolev, ver \cite{LegendreSobolevComp}. En la figura \ref{fig:LS} pueden verse dos instancia con $\mu=\frac{1}{8}$ y $\mu=\frac{1}{16}$,
\begin{figure}[!htbp]
\vspace*{-0.9cm}
  \centering
  ...
  \caption{Primeros veintes polinomios de Legendre-Sobolev, en el intervalo $[0,1]$ }
  \label{fig:LS}
\end{figure}
