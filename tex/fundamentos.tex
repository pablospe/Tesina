...
En esta sección se introducirán algunos conceptos básicos que utilizaremos a lo largo del trabajo.
...
el grado de $L_i$ es exactamente $i$.  Se conoce una fórmula cerrada para el cálculo de los coeficientes $C_{ij}$ ortonormales. A continuación se muestra dicha fórmula, que puede encontrarse en \cite{abramowitz70a},
\begin{align}
...
Otros polinomios ortogonales que pueden usarse son los de Chebyshev. A diferencia de los de Legendre, la función peso es $w(t)=(1-x^2)^{\frac{1}{2}}$. Se pueden generar estos polinomios con el proceso de ortogonalización de Gram-Schmidt en el intervalos $[0,1]$.
