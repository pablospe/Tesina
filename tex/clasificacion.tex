...
donde $c_i$ indica la clase de la entrada $x_i$. Se desea determinar la clase $\hat{c}$ de una nueva entrada $\hat{x}$, donde $\hat{x} \notin \mathcal{D}$. Este proceso se lo llama clasificación.
