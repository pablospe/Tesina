...
El reconocimiento tiene 3 etapas:
    ...
    En este paso se extraen características (feature) de los trazos. Hay varios tipos de features: los relativos a la apariencia que incluye, por ejemplo, proporción entre la altura y ancho; los relativos a propiedades geométricas, como ser la cantidad de loops e intersecciones; los relativos al estilo de escritura, como la dirección y cantidad de strokes.
