...
\noindent
A diferencia del enfoque \textit{Offline} de handwriting recognition, el cual pretende reconocer caracteres a partir de una imagen, el enfoque \textit{Online} intenta el reconocimiento a partir de trazos de una curva. Se posee, además de los puntos, el orden en que cada uno de ellos fue escrito. Así, es posible diferenciar distintos estilos de escrituras, a pesar de que el resultado final puede que sea el mismo. Ambos enfoques están esquemáticamente representados en la figura \ref{fig:off|on-line}. La utilización de un stylus en un dispositivo electrónico permite usar el enfoque online.
